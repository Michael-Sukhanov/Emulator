...
enum PacketType {control = 0, status = 1, resend = 2, not_defined=3};
struct PacketHeader {
    ...
    PacketHeader(const quint32 &word) {memcpy(this, &word, 4);}//memcpy копирует количество битов n (в нашем случае 4) из строки str1 в строку this
